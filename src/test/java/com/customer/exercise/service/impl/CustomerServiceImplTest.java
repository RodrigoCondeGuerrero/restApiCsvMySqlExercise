package com.customer.exercise.service.impl;
...
import com.customer.exercise.mapper.CustomerMapper;
import com.customer.exercise.repository.CustomerRepository;
...
class CustomerServiceImplTest
{
    ...
    public void getCustomerShouldReturnCustomer() throws ObjectNotFoundException
    {
        ...
        Assertions.assertEquals(customerDto, serviceImpl.getCustomer(anyInt()));
    }
    ...
    void saveCustomer()
    {
        ...
        Assertions.assertEquals(customerDto, serviceImpl.saveCustomer(customerDto));
    }
